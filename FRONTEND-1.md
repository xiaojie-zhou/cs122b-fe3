...
<table>
  ...
  <tbody>
    <tr></tr>
    <tr>
      <th align="left" >This page facilitates user account registration. For all responses from the server we would like to see a <code>alert(JSON.stringify(response.data, null, 2))</code> of the response</th>
    </tr>
  </tbody>
</table>
